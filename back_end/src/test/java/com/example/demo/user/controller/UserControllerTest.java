...
//
//    private UserSearchResponse mockResponse1;
//    private UserSearchResponse mockResponse2;
//
//    @BeforeEach
//    void setUp() {
//        mockResponse1 = new UserSearchResponse();
...
//        mockResponse1.setWantedPosition(List.of(PositionEnum.BACKEND));
...
//
//        mockResponse2 = new UserSearchResponse();
...
//        mockResponse2.setWantedPosition(List.of(PositionEnum.FRONTEND));
...
//
//    @Test
//    void searchUsersWithoutTeam_WithCondition_성공_모든_사용자_반환() {
//        UserSearchRequest request = new UserSearchRequest();
//        List<UserSearchResponse> mockResponses = Arrays.asList(mockResponse1, mockResponse2);
//
//        when(userService.searchUsersWithoutTeam(any(UserSearchRequest.class)))
//                .thenReturn(mockResponses);
//
//        ResponseEntity<ApiResponse> response = userController.searchUsersWithoutTeamWithCondition(request);
//
//        assertThat(response.getStatusCode().value()).isEqualTo(200);
//        assertThat(response.getBody().getStatus()).isEqualTo(200);
//
//        @SuppressWarnings("unchecked")
//        List<UserSearchResponse> data = (List<UserSearchResponse>) response.getBody().getData();
//        assertThat(data).hasSize(2);
//        assertThat(data.get(0).getUserName()).isEqualTo("테스트유저1");
//        assertThat(data.get(0).getWantedPosition()).isEqualTo(List.of(PositionEnum.BACKEND));
//        assertThat(data.get(1).getUserName()).isEqualTo("테스트유저2");
//        assertThat(data.get(1).getWantedPosition()).isEqualTo(List.of(PositionEnum.FRONTEND));
//    }
//
//    @Test
//    void searchUsersWithoutTeam_WithCondition_포지션_필터링() {
//        UserSearchRequest request = new UserSearchRequest();
//        request.setWantedPosition(List.of(PositionEnum.BACKEND));
//
//        List<UserSearchResponse> mockResponses = Arrays.asList(mockResponse1);
//
//        when(userService.searchUsersWithoutTeam(any(UserSearchRequest.class)))
//                .thenReturn(mockResponses);
//
...
//
//    @Test
//    void searchUsersWithoutTeam_WithCondition_기술스택_필터링() {
//        UserSearchRequest request = new UserSearchRequest();
...
//
//    @Test
//    void searchUsersWithoutTeam_WithCondition_조건에_맞는_사용자_없음() {
//        UserSearchRequest request = new UserSearchRequest();
//        request.setWantedPosition(List.of(PositionEnum.AI));
//
//        when(userService.searchUsersWithoutTeam(any(UserSearchRequest.class)))
